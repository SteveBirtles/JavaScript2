        ...
        for (let j = 0; j < puzzleSize; j++) {
            if (pieces[i][j] !== null) {
                context.drawImage(image,
                    pieces[i][j].x*sourcePieceWidth, pieces[i][j].y*sourcePieceHeight,
                    sourcePieceWidth, sourcePieceHeight,
                    left + i*destinationPieceWidth, top + j*destinationPieceHeight,
                    destinationPieceWidth - spacing, destinationPieceHeight - spacing);
            }
        }
    }
